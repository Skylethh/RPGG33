      ...
      html: `
        <body>
          <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
            <h2 style="text-align: center; text-transform: uppercase;color: #f0a742;">SAGAI - Email Verification</h2>
            <p>Please use the verification code below to complete your registration:</p>
            <div style="text-align: center; background-color: #1a1a2e; padding: 15px; font-size: 24px; letter-spacing: 5px; font-weight: bold; color: #f0a742; border-radius: 8px; margin: 20px 0;">
              ${code}
            </div>
